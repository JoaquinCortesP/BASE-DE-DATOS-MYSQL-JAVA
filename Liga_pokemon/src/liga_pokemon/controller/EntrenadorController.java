...
public class EntrenadorController {
    ...
    public List<Entrenador> obtenerEntrenadores(int id){
        ...
        try {
            ResultSet rs = cx.EjecutarQuery("select * from Entrenador" + id + ";");
            ...
            while(rs.next()){
                entrenadores.add(new Entrenador(
                        ...
                        rs.getString("Region"),
                        rs.getInt("Medallas"),
                        rs.getInt("nivel de experiencia")));
    ...
    public void agregarLibro(String parNombre, String region, int medallas, int nivelDeExperiencia){
